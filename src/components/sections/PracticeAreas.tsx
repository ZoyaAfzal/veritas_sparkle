          ...
          {areas.map(({ icon: Icon, title, desc }, idx) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="mt-6 inline-flex items-center gap-2 font-accent text-[10px] uppercase tracking-[0.25em] text-gold group-hover:text-gold/80 transition-colors">
                  Learn More

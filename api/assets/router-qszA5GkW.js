...
const appCss = "/assets/styles-nqojzxZC.css";
...
function Logo({ className = "" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: `flex items-center gap-2 ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Scale, { className: "h-5 w-5 text-gold", strokeWidth: 1.5 }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-accent text-base", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold font-bold", children: "VERITAS" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-text-primary font-light ml-1", children: "LAW" })
    ] })
  ] });
}
const links = [
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-bg-primary/95 backdrop-blur-xl border-b border-border-gold" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 lg:px-10 h-20 flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-10", children: links.map((l) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 block transition-transform duration-300 group-hover:-translate-y-0.5", children: l.label }),
                  ...
                  ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-2 left-0 right-0 h-px bg-gold scale-x-0 transition-transform duration-300 group-hover:scale-x-100" })
                ]
              },
              l.to
            );
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "lg:hidden text-gold p-2", onClick: () => setOpen(true), "aria-label": "Menu", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "h-6 w-6" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 h-20 border-b border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setOpen(false), className: "text-gold p-2", "aria-label": "Close", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-6 w-6" }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex flex-col items-center justify-center gap-8 flex-1", children: [
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-bg-secondary border-t border-border-gold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 lg:px-10 py-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row lg:items-start lg:justify-between gap-10 pb-12 border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 font-display text-text-secondary text-lg", children: "Where truth meets justice." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex gap-4", children: [Linkedin, Twitter, Facebook, Instagram].map((Icon2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "#",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-10 lg:gap-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          FooterCol,
          {
            title: "Firm",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-accent text-[11px] uppercase text-gold mb-5", children: "Contact" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-text-secondary", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
              "1100 Liberty Avenue",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              "New York, NY 10013"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "+1 (212) 555-0198" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "hello@veritaslaw.com" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-8 flex justify-center text-xs text-text-tertiary font-accent uppercase tracking-[0.18em]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      "Powered by",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
...
function FooterCol({ title, links: links2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-accent text-[11px] uppercase text-gold mb-5", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3 text-sm text-text-secondary", children: links2.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: l.to, className: "hover:text-gold transition-colors", children: l.label }) }, l.label)) })
  ] });
}
...
const Route$7 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Veritas Law — premium legal counsel since 1998. Corporate, criminal, family, immigration & litigation."
      },
      { property: "og:title", content: "Veritas Law — Where Truth Meets Justice" },
      {
        property: "og:description",
        content: "Strategic legal counsel backed by 25+ years of experience and 1,200+ cases won."
      },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Veritas Law" },
...
const Route$6 = createFileRoute("/sitemap.xml")({
  server: {
    handlers: {
      GET: async () => {
        const paths = ["/", "/about", "/practice-areas", "/attorneys", "/case-studies", "/contact"];
...
const $$splitComponentImporter$5 = () => import("./practice-areas-Bm1XleU9.js");
const Route$5 = createFileRoute("/practice-areas")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Nine practice groups: corporate, criminal, family, immigration, litigation, real estate, IP, employment and international law."
    }, {
      property: "og:title",
      content: "Practice Areas — Veritas Law"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$4 = () => import("./contact-BfQHM9RM.js");
...
const $$splitComponentImporter$3 = () => import("./case-studies-6SNLxl4k.js");
const Route$3 = createFileRoute("/case-studies")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Landmark outcomes from Veritas Law across corporate, criminal, family and immigration matters."
    }, {
      property: "og:title",
      content: "Case Studies — Veritas Law"
    }, {
      property: "og:description",
      content: "Selected landmark cases from our partners."
    }],
    links: [{
      rel: "canonical",
      href: "/case-studies"
...
const $$splitComponentImporter$2 = () => import("./attorneys-BfmFjmTW.js");
const Route$2 = createFileRoute("/attorneys")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Meet the partners and associates of Veritas Law."
    }, {
      property: "og:title",
      content: "Attorneys — Veritas Law"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$1 = () => import("./about-qzHsREgp.js");
const Route$1 = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Founded in 1998, Veritas Law brings principled, partner-led counsel to every client matter."
    }, {
      property: "og:title",
      content: "About — Veritas Law"
    }, {
      property: "og:description",
...
const $$splitComponentImporter = () => import("./index-CoYPQfK6.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Premium legal counsel since 1998. 1,200+ cases won across corporate, criminal, family, immigration and litigation matters."
    }],
    links: [{
      rel: "canonical",
      href: "/"
...
const PracticeAreasRoute = Route$5.update({
  id: "/practice-areas",
  path: "/practice-areas",
  getParentRoute: () => Route$7
});
...
const AttorneysRoute = Route$2.update({
  id: "/attorneys",
  path: "/attorneys",
  getParentRoute: () => Route$7
});
